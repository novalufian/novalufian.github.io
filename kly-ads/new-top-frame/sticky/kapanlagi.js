var _PARENT_BODY_ = null;
    ...
    function _INIT_STICKY_TOPFRAME_() {
        ...
        _PARENT_BODY_TARGET_ = document.querySelectorAll(".container")[2];
    ...
    function _TOPFRAME_STICKY_STYLE_() {
        ...
        div#div-gpt-ad-topfrm-parallax-wrapper.sticky #div-gpt-ad-kapanlagi-topfrm-oop iframe {
	...
	var _CONTAINER_TARGET_ = document.querySelectorAll(".container");
		...
		var _FIRST_CHILD_ELEMENT_ = _CONTAINER_TARGET_[1].firstElementChild;
		_CONTAINER_TARGET_[1].insertBefore(_CONTAINER_TARGET_[0], _FIRST_CHILD_ELEMENT_);
		console.log(_CONTAINER_TARGET_[1])
		_CONTAINER_TARGET_[1].appendChild(document.querySelector("footer"));
    	}else{
		var _FIRST_CHILD_ELEMENT_ = _CONTAINER_TARGET_[2].firstElementChild;
		_CONTAINER_TARGET_[2].insertBefore(document.querySelector(".navbar"), _FIRST_CHILD_ELEMENT_);
		_CONTAINER_TARGET_[2].insertBefore(_CONTAINER_TARGET_[1], _FIRST_CHILD_ELEMENT_);
    	}
    }
