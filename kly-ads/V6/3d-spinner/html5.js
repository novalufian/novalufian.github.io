...
InnityVideo.prototype.videoHandler = function(e) {
	if(this.started && e.type == "pause" && this.currentTime < this.duration) {
		...
		if (parent.klyDpfParam.dfp_use_video_source !="youtube") {
	        	klyDpfParam.dfp_use_video_obj.player_.tech_.pause()
	       }
	}
	if(this.started && e.type == "play") {
	       if (parent.klyDpfParam.dfp_use_video_source !="youtube") {
	        	klyDpfParam.dfp_use_video_obj.player_.tech_.play()
	       }
...
DesignerClickTag = {
    clickTAG: 'http://i.appsploration.com/sk/clicktag/clicktag.html',
    clickTAG1: 'http://i.appsploration.com/sk/clicktag/clicktag1.html',
    clickTAG2: 'http://i.appsploration.com/sk/clicktag/clicktag2.html',
    clickTAG3: 'http://i.appsploration.com/sk/clicktag/clicktag3.html',
    clickTAG4: 'http://i.appsploration.com/sk/clicktag/clicktag4.html',
    clickTAG5: 'http://i.appsploration.com/sk/clicktag/clicktag5.html'
};
