...
function InnityAppsVideoPreview(containerID, videoID, options, videoScreenCapImgSrc, canvasOptions, videouioptions) {
    ...
    function InnityAppsVideoUI(containerID, canvasID, videoID, options, videoScreenCapImgSrc, innityAppsVideoPreview) {
        ...
        videoEl = [{
            id: 'innityAppsLoadContainer' + customVideoID,
            cssClass: ['preview-ui-container'],
            childs: [{
                elType: 'img',
                id: 'innityAppsLoadBg' + customVideoID,
            ...
            if (options.fullscreen) {
                ...
                var track = {
                    openfs: (options.tracking === true) ? function() {
                        InnityHTMLAd.track(trackVideoID + "_OpenFullscreen");
                    } : function() {
                        return;
                    },
                    closefs: (options.tracking === true) ? function() {
                        InnityHTMLAd.track(trackVideoID + "_CloseFullscreen");
                    } : function() {
                        return;
                    }
                };
