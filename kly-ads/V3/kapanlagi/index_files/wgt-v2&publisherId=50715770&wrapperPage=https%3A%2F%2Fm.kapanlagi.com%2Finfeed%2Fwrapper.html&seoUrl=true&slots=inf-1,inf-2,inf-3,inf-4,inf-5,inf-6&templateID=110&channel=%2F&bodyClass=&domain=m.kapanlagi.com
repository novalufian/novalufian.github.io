...
{this.slotParams=[];this.enableTracker=true;this.publisherID='50715770';this.publisherTrackerClick='';this.publisherTrackerImpresssion='';this.slots="inf-1,inf-2,inf-3,inf-4,inf-5,inf-6";this.slots=this.slots.split(",");this.isIAB='';this.firstSlot=this.slots[0];this.slotBackfills=[];this.clockInterval;}
...
{this.publisherID=params.publisherId;this.slots=params.slots;this.firstSlot='inf-gpt-8d93165e47e3aabd818efda48675f838';this.init();},tweek_tempo:function()
...
{var th=this;var gptFrameID='inf-gpt-8d93165e47e3aabd818efda48675f838';var divNode=document.createElement("div");divNode.id=gptFrameID;divNode.style="display: none;";document.body.appendChild(divNode);var frameID=th.createIframe("50715770",gptFrameID,"<!DOCTYPE HTML> <html> <head> <base target=\"_parent\"> <meta http-equiv=\"content-type\" content=\"text/html\" /> <meta name=\"author\" content=\"KLNmalang\" /> <title>Safe Frame</title> <style> #inf-lb-container { clear: both; } #inf-lb-container .inf-lb-item{ width: 50%; float: left; } </style> <script async=\"async\" src=\"https://www.googletagservices.com/tag/js/gpt.js\"></script> <script> var googletag = googletag || {}; googletag.cmd = googletag.cmd || []; var elContainer = JSON.parse(\'[\"#inf-1\",\"#inf-2\",\"#inf-3\",\"#inf-4\",\"#inf-5\",\"#inf-6\"]\'); var bodyID = \"gpt-522a2c7201a55bb190a3f79732e19d0f\"; </script> <script> var slotCount = 0; var slotParams = []; googletag.cmd.push(function() { googletag.defineOutOfPageSlot(\"/36504930/infeed.id/m.kapanlagi.com/dfp-natAds-1\", \"div-gpt-ad-6e6acc8dd47f0b2d77fa8cdc7b6c7778\").addService(googletag.pubads());googletag.defineOutOfPageSlot(\"/36504930/infeed.id/m.kapanlagi.com/dfp-natAds-2\", \"div-gpt-ad-f9995f68321b492b037513d4aa6fa1c2\").addService(googletag.pubads());googletag.defineOutOfPageSlot(\"/36504930/infeed.id/m.kapanlagi.com/dfp-natAds-3\", \"div-gpt-ad-a3cfd54aaeba40fbd68ad4becea5bca2\").addService(googletag.pubads());googletag.defineOutOfPageSlot(\"/36504930/infeed.id/m.kapanlagi.com/dfp-natAds-4\", \"div-gpt-ad-0d268dee8c7c9c424c8cfd6b961c935e\").addService(googletag.pubads());googletag.defineOutOfPageSlot(\"/36504930/infeed.id/m.kapanlagi.com/dfp-natAds-5\", \"div-gpt-ad-a810da9f742eae722562e62ac8fab603\").addService(googletag.pubads());googletag.defineOutOfPageSlot(\"/36504930/infeed.id/m.kapanlagi.com/dfp-natAds-6\", \"div-gpt-ad-78fb9748d1c3e6427a53d4e7d6d73762\").addService(googletag.pubads()); googletag.pubads().addEventListener(\"slotRenderEnded\", function(event) { var dfp_slotDelivered = event.isEmpty ? \"none\" : \"block\"; /* check wheter there is ads or not*/ var dfp_slotAdUnitPath = event.slot.getSlotId().getAdUnitPath(); /* get adunit path */ var dfp_slotAdUnitID = event.slot.getSlotId().getId(); /* get adunit container id*/ /*if ( dfp_slotDelivered==\"block\" && parentID==event.slot.getSlotId().m)*/ if ( dfp_slotDelivered==\"block\") { /*console.log(event.slot.getSlotId().getName()); slotParams.push(params);*/ }else{ /*IMPORTANT : add empty object to simulate empty campaign on container*/ slotParams.push({}); } document.getElementById(bodyID).setAttribute(\"params\", JSON.stringify(slotParams)); slotCount++; }); var urlPath = parent.window.location.href, urlArray=urlPath.split(\"/\"), dfp_Article = urlArray[urlArray.length - 1]; /* Start Global targetting tags */ document.getElementById(bodyID).setAttribute(\"data-tags\", \'none\'); if(typeof parent.window.kly !== \'undefined\') { var tagForAds = parent.window.kly.gtm.tag.replace(/[^A-Za-z0-9|\\- ]/ig,\"\").trim().split(\"|\").map(item => item.trim().toLowerCase()); (tagForAds.length) ? googletag.pubads().setTargeting(\"tags\", tagForAds) : \'\'; document.getElementById(bodyID).setAttribute(\"data-tags\", tagForAds); } if(typeof parent.window.kmklabs !== \'undefined\') { var tagForAds = parent.window.kmklabs.gtm.tag.replace(/[^A-Za-z0-9|\\- ]/ig,\"\").trim().split(\"|\").map(item => item.trim().toLowerCase()); (tagForAds.length) ? googletag.pubads().setTargeting(\"tags\", tagForAds) : \'\'; document.getElementById(bodyID).setAttribute(\"data-tags\", tagForAds); } /* End Global targetting tags */ googletag.pubads().setTargeting(\"currentUrl\", urlPath); googletag.pubads().setTargeting(\"page_url\", [dfp_Article]); googletag.pubads().setTargeting(\'infeed_isIAB\', \'\'); googletag.pubads().setTargeting(\"channel\", \'/\'); googletag.pubads().enableSingleRequest(); googletag.enableServices(); }); function getTemplateID() { return 110; } function setResParam(parentID, params) { /*console.log(params);*/ slotParams.push(params); } /** * CREATE Additional custom 3rd party script * @param elType string type of element (script|div|style) * @param elAttributes object array collections of element attr complete with its value * @param elNode string node element ID where its going to be added */ create3rdPartyElement = function(elType, elAttributes, elNode) { var parentID = getParrentEl(); /*checking node element existance*/ /*if(!parent.document.getElementById(elNode)) elNode = parentID;*/ if( parent.document.querySelector(elContainer[elNode]) ) { elNode = elContainer[elNode]; } else { elNode = parentID; } var ob_script = parent.document.createElement(elType); /*Itterate objects attributes*/ Object.keys(elAttributes).forEach(function (key) { if(key==\'src\'){ /*handling script src*/ ob_script.src = elAttributes[key]; }else if(key==\'cssStyle\'){ /*handling css styles*/ if(!!(window.attachEvent && !window.opera)) { ob_script.styleSheet.cssText = elAttributes[key]; } else { var styleText = document.createTextNode(elAttributes[key]); ob_script.appendChild(styleText); } }else if(key==\'jsScript\'){ /*handling script tag*/ try { var tagCode = document.createTextNode(elAttributes[key]); ob_script.appendChild(tagCode); } catch(e) { ob_script.text = elAttributes[key]; } }else{ ob_script.setAttribute(key, elAttributes[key]); } }); if(parent.document.querySelector(elNode)) parent.document.querySelector(elNode).appendChild(ob_script); }; function getCurrentLocationAddr() { return parent.window.location.href; } function getParrentEl() { var currentID = this.frameElement.getAttribute(\'id\'); return parent.document.getElementById(currentID).parentNode.getAttribute(\'id\'); } </script> </head> <body style=\"padding: 0;margin: 0; overflow: hidden; width: 0; height: 0;\" id=\"gpt-522a2c7201a55bb190a3f79732e19d0f\"> <!-- /36504930/infeed.id/m.kapanlagi.com/dfp-natAds-1 --> <div id=\"div-gpt-ad-6e6acc8dd47f0b2d77fa8cdc7b6c7778\" class=\"inf-item\"> <script> googletag.cmd.push(function() { googletag.display(\"div-gpt-ad-6e6acc8dd47f0b2d77fa8cdc7b6c7778\"); }); </script> </div><!-- /36504930/infeed.id/m.kapanlagi.com/dfp-natAds-2 --> <div id=\"div-gpt-ad-f9995f68321b492b037513d4aa6fa1c2\" class=\"inf-item\"> <script> googletag.cmd.push(function() { googletag.display(\"div-gpt-ad-f9995f68321b492b037513d4aa6fa1c2\"); }); </script> </div><!-- /36504930/infeed.id/m.kapanlagi.com/dfp-natAds-3 --> <div id=\"div-gpt-ad-a3cfd54aaeba40fbd68ad4becea5bca2\" class=\"inf-item\"> <script> googletag.cmd.push(function() { googletag.display(\"div-gpt-ad-a3cfd54aaeba40fbd68ad4becea5bca2\"); }); </script> </div><!-- /36504930/infeed.id/m.kapanlagi.com/dfp-natAds-4 --> <div id=\"div-gpt-ad-0d268dee8c7c9c424c8cfd6b961c935e\" class=\"inf-item\"> <script> googletag.cmd.push(function() { googletag.display(\"div-gpt-ad-0d268dee8c7c9c424c8cfd6b961c935e\"); }); </script> </div><!-- /36504930/infeed.id/m.kapanlagi.com/dfp-natAds-5 --> <div id=\"div-gpt-ad-a810da9f742eae722562e62ac8fab603\" class=\"inf-item\"> <script> googletag.cmd.push(function() { googletag.display(\"div-gpt-ad-a810da9f742eae722562e62ac8fab603\"); }); </script> </div><!-- /36504930/infeed.id/m.kapanlagi.com/dfp-natAds-6 --> <div id=\"div-gpt-ad-78fb9748d1c3e6427a53d4e7d6d73762\" class=\"inf-item\"> <script> googletag.cmd.push(function() { googletag.display(\"div-gpt-ad-78fb9748d1c3e6427a53d4e7d6d73762\"); }); </script> </div> </body> </html>",false);var frameTag=document.getElementById(frameID);th.templateBackfill();if(frameTag)
...
{var img=document.getElementById(this.firstSlot).appendChild(document.createElement('img'));var imgID="img-50715770-"+this.firstSlot;img.setAttribute("id",imgID);img.setAttribute("src",this.publisherTrackerImpresssion);img.setAttribute("style","width: 0;height: 0;visibility: hidden;");}},buildAds:function()
{var totalAds=this.slotParams?this.slotParams.length:0;var platform="outstream";var infeedTemplate='';var mainContent='';var html="<div class=\"inf-cont\"> <div class=\"inf-wrapper\"> <div class=\"inf-img\"> <a href=\"###LINK###\"> <img src=\"###IMAGE###\" alt=\"###TEXT###\"> </a> </div> <div class=\"inf-text\"> <span><a href=\"/infeed/\">###LABEL###</a></span> <div> <a href=\"###LINK###\">###TEXT###</a> </div> </div> </div> </div>";var css="<style> .inf-cont { padding: 8px 5px 12px 5px; border-bottom: 1px solid #ececec; text-align: left } .inf-wrapper { padding: 0; min-height: 60px } .inf-img { float: left; margin: 0 10px 0 0 } .inf-img a { background-color: transparent; border-bottom: 0; padding: 0; width: 120px; height: 65px; overflow: hidden; display: block; } .inf-img a img { width: 120px; margin-top: 5px; } .inf-text { margin-left: 130px } .inf-text span { font: normal 12px Arial, Helvetica, sans-serif; color: #a3a3a3; } .inf-text span a { color: #a3a3a3; text-decoration: none; } .inf-text div { font: bold 15px arial; margin: 0 } .inf-text div a { font: normal 15px Arial, Helvetica, sans-serif; padding: 0; text-decoration: none; background-color: transparent; color: #000; border: 0; line-height: 1.2em; } .inf-text div a:hover { color: #428bca; } </style>";if(this.slotParams)
{for(var i in this.slotParams)
{if(this.slots[i]&&Object.keys(this.slotParams[i]).length>0)
{var param=this.slotParams[i];var body=param.adunitID?this.renderLayout(html+css,param,"_self"):'';mainContent="<!DOCTYPE HTML> <html> <head> <base target=\"_parent\"> <meta http-equiv=\"content-type\" content=\"text/html\" /> <meta name=\"author\" content=\"KLNmalang\" /> <title>Safe Frame</title> <style> #inf-outstream-container{ } </style> </head> <body style=\"padding: 0;margin: 0; overflow: hidden; width: 100%;\" class=\"inf-/ \"> <div id=\"inf-outstream-container\" style=\"padding: 0;\"> ###MAIN_CONTENT### <div style=\"clear: both; height: 0;\"></div> </div> </body> <script> /* Start Global targetting tags */ if(typeof parent.window.kly !== \'undefined\') { var tags = parent.window.kly.gtm.tag.replace(/[^A-Za-z0-9|\\- ]/ig,\"\").trim().split(\"|\").map(item => item.trim().toLowerCase().replace(/ /g,\'-\')); } if(typeof parent.window.kmklabs !== \'undefined\') { var tags = parent.window.kmklabs.gtm.tag.replace(/[^A-Za-z0-9|\\- ]/ig,\"\").trim().split(\"|\").map(item => item.trim().toLowerCase().replace(/ /g,\'-\')); } if( tags ) { for( var i in tags ) { if( tags[i] ) { document.body.classList.add(tags[i]); } } } /* End Global targetting tags */ </script> </html>";mainContent=mainContent.replace(/###MAIN_CONTENT###/gi,body);var targetElement=(this.slots[i]).substr(0,(this.slots[i]).length-1)+(param.adunitID).substr((param.adunitID).length-1,1);var frameID=this.createIframe("50715770",targetElement,mainContent,true);this.resizeIframe(targetElement,frameID,totalAds,true);}
else
...
{infeedTemplate='<div class="inf-cont">'+this.slotBackfills[current_slot]+'</div>';current_slot.innerHTML='';mainContent="<!DOCTYPE HTML> <html> <head> <base target=\"_parent\"> <meta http-equiv=\"content-type\" content=\"text/html\" /> <meta name=\"author\" content=\"KLNmalang\" /> <title>Safe Frame</title> <style> #inf-outstream-container{ } </style> </head> <body style=\"padding: 0;margin: 0; overflow: hidden; width: 100%;\" class=\"inf-/ \"> <div id=\"inf-outstream-container\" style=\"padding: 0;\"> ###MAIN_CONTENT### <div style=\"clear: both; height: 0;\"></div> </div> </body> <script> /* Start Global targetting tags */ if(typeof parent.window.kly !== \'undefined\') { var tags = parent.window.kly.gtm.tag.replace(/[^A-Za-z0-9|\\- ]/ig,\"\").trim().split(\"|\").map(item => item.trim().toLowerCase().replace(/ /g,\'-\')); } if(typeof parent.window.kmklabs !== \'undefined\') { var tags = parent.window.kmklabs.gtm.tag.replace(/[^A-Za-z0-9|\\- ]/ig,\"\").trim().split(\"|\").map(item => item.trim().toLowerCase().replace(/ /g,\'-\')); } if( tags ) { for( var i in tags ) { if( tags[i] ) { document.body.classList.add(tags[i]); } } } /* End Global targetting tags */ </script> </html>";mainContent=mainContent.replace(/###MAIN_CONTENT###/gi,infeedTemplate);mainContent=mainContent.replace(/width: 100%;/gi,"/width: auto;");var frameID=this.createIframe("50715770",current_slot,mainContent,true);this.resizeIframe(current_slot,frameID,1,true);}},renderLayout:function(content,param,target)
...
var wrapperURL='https://m.kapanlagi.com/infeed/';var newsUrl_=param.link.split('/');var newsUrl=newsUrl_[newsUrl_.length-1];if(newsUrl)wrapperURL=wrapperURL+newsUrl+'';if(param.link)
...
{iframe.setAttribute("style","visibility: hidden; display: none; width: 0; height: 0;");var css_custom="<style>.inf-filled-campaign{clear: both;}</style>";var divNode=document.createElement("div");divNode.id="infeed-custom-css";divNode.style="display: none;";divNode.innerHTML=css_custom;document.body.appendChild(divNode);}
...
{InfResizeFrame_8d93165e47e3aabd818efda48675f838(cntnrID,frameID,totalAds,isOutstream);document.getElementById(frameID).onload=function(){InfResizeFrame_8d93165e47e3aabd818efda48675f838(cntnrID,frameID,totalAds,isOutstream);};window.onresize=function(event){InfResizeFrame_8d93165e47e3aabd818efda48675f838(cntnrID,frameID,totalAds,isOutstream);};window.addEventListener("orientationEvent",function(){InfResizeFrame_8d93165e47e3aabd818efda48675f838(cntnrID,frameID,totalAds,isOutstream);});window.addEventListener("resize",function(){InfResizeFrame_8d93165e47e3aabd818efda48675f838(cntnrID,frameID,totalAds,isOutstream);});}},templateBackfill:function()
{for(i in this.slots)
...
{this.slotBackfills[this.slots[i]]=chlds[j].innerHTML;chlds[j].remove();}}}}}};(function(doc){var infSdk=new infSdkLoader();infSdk.init();})(document);function InfResizeFrame_8d93165e47e3aabd818efda48675f838(cntnrID,frameID,totalAds,isOutstream)
...
document.getElementById(cntnrID).style.width=bodyWidth;document.getElementById(cntnrID).style.height=bodyHeight+"px";document.getElementById(frameID).style.width=bodyWidth;document.getElementById(frameID).style.height=bodyHeight+"px";},1000);}/*2020-04-07 11:09:13 in*//*2020-04-07 11:12:59 out*/