...
try {
	var __IntegralASConfig = {
		...
		sp_cdnScripts: {xsca: "static.adsafeprotected.com/xsca.17.4.85.js", sca: "static.adsafeprotected.com/sca.17.4.114.js", main: "static.adsafeprotected.com/main.19.8.67.js"},
		protocol: 'https',
		jsref: "https:\/\/m.bola.net\/",
		asid: "8e640988-7887-11ea-a9d6-02aa41dfc264",
		...
		mode: "rjss",
		requrl: "",
		dtBaseURL: "https:\/\/dt.adsafeprotected.com\/dt?advEntityId=419024",
		adsafeSrc: "https:\/\/fw.adsafeprotected.com\/rfw\/www.googletagservices.com\/419024\/43888477\/dcm\/dcmads.js",
		tpiLookupURL: "",
		getTpl: "false",
		use100v: false,
		useBapiCallback: "",
		useViewabilityNotification: "",
		scriptUrl: "https:\/\/fw.adsafeprotected.com\/rjss\/www.googletagservices.com\/419024\/43888477\/dcm\/dcmads.js",
		accountForSadImps: '',
		sendCookie: 'false',
		cookieBaseURL: 'sc.iasds01.com\/dtc?advEntityId=419024&pubEnt=43888477',
		fwMonitoring: 'false',
		doNothing: false,
		mn: "app03sg",
		mobOrTab: false,
		app: false,
		mobFwUrl: "https:\/\/mobile.adsafeprotected.com\/internal\/blocking\/app\/initial\/419024\/43888477?redirectUrl=https%3A%2F%2Fwww.googletagservices.com%2Fdcm%2Fdcmads.js",
		anId: '',
		advEntityId: '419024',
		pubEntityId: '43888477',
		videoId: '',
		videoChannel: '',
		rts: {},
...
lc=function(){return{parse:function(a){}}},lb=function(){var a={},b=function(b){var c;d.isUndef(a[b])&&(c=l.jsFeatures,a[b]=!1,-1!==c.indexOf(b)&&(c=RegExp(b+"(?=$|,)|"+b+":(?!,|$)(.?\\d*(?=,|$))").exec(c)))&&(c=c[1],a[b]=!c||c>100*r.random());return a[b]},c={es:"everySecond",sc:"usesca",ha:"usehaps"},e={gmnp:"groupm_native_publisher","for":"forceAppend",b11:"b11",cnod:"cnod"},f=function(){var b,f;b=d(c).mapToObj(function(b,c){var e={};e[b]=d.fromBoolToNum(a[c]);return e});f=d(e).mapToObj(function(a,
b){var c={};c[a]=d.fromBoolToNum(h(b));return c});f.gm=d.fromBoolToNum(s.usesGroupMCustomMetric());return d(b).mixin(f)},h=function(a){a=l[a];return!0===a||"true"===a||d.isFunction(a)};d(c).each(function(a,c){b(c)});return{on:b,bootstrapOn:h,bootstrapperHas:function(a){a=d.isStr(a)?[a]:a;return d(a).map(function(a,b){if(d.isDef(l[b]))return 1}).length===a.length},getEnabledScriptUrl:function(a){var c=b("use"+a);a=l.sp_cdnScripts&&l.sp_cdnScripts[a];return c&&a},output:function(){return d(f()).toParams()}}},
...
Math.max(c.scrX,e.scrX),f=Math.max(c.scrY,e.scrY),g=Math.min(c.scrX+c.width,e.scrX+e.width),c=Math.min(c.scrY+c.height,e.scrY+e.height),g=g-d,c=c-f;h=H({scrX:d,scrY:f,width:0<g?g:0,height:0<c?c:0})}}),f=r.round(h.area()/a.area()*100));return f}}},pb=function(){var a,b=!1,c;a=function(a){var b=[];b.push(a.slice(0,8));b.push(a.slice(8,12));b.push(a.slice(12,16));b.push(a.slice(16,20));b.push(a.slice(20));return b.join("-")}(function(){var a="";try{for(var b,c=x.Uint32Array&&x.crypto&&x.crypto.getRandomValues;32>
...
getMaxNumber:function(){return Number.MAX_VALUE},getTop:function(){s.isDomless();return top},getDoc:function(){s.isDomless();return L},getIntersectionObserver:function(a,b){s.isDomless();return new IntersectionObserver(a,b)},pow:function(a,b){return Math.pow(a,b)}},wb=function(){return{createInstance:function(){return s.isDomless()?new oc:new pc}}},pc=function(){var a,b=!1,c=!1,e=k.getAggregator().request("features"),f=new ea,h=function(){var b;b=923747==l.anId||925955==l.anId;e.on("blur")||e.on("abcAudit")&&
b?(b=r.getWindow(),b=s.friendly&&b.top.document&&(d.isFunction(b.top.document.hasFocus)||d(b.top.document.hasFocus).isObj())&&!b.top.document.hasFocus()||(d.isDef(a.prop)?r.getDoc()[a.prop]:null)):b=d.isDef(a.prop)?r.getDoc()[a.prop]:null;return b},u=function(){var b=r.getWindow(),c=function(){f.run(h())};y.addEvent(b,"focus",c,!0);y.addEvent(b,"blur",c,!0);a.event&&y.addEvent(r.getDoc(),a.event,c,!0)};a=function(){var a="hidden",c="visibilitychange",e=r.getDoc();d.isUndef(e.hidden)?d(["moz","ms",
"webkit"]).each(function(f,h){var u=h+"Hidden";d.isDef(e[u])&&(a=u,c=h+c,b=!0)}):b=!0;return b?{prop:a,event:c}:{}}();return{isHidden:h,onHiddenChange:function(a){f.push(a);c||(c=!0,u())},supportsVisAPI:function(){return b}}},oc=function(){return{isHidden:function(){return!1},onHiddenChange:function(a){},supportsVisAPI:function(){return!0}}},yb=function(){return{createInstance:function(a,b){return s.isDomless()?new qc:new rc(a,b)}}},rc=function(a,b){var c,e=function(a){for(var b in a)if(a.hasOwnProperty(b)){var c=
...
b.getWindow();f=!1;d.isDef(h.navigator)&&d.isDef(h.navigator.userAgent)&&(h=h.navigator.userAgent.match(/Firefox\/([\.0-9]+)/),null!==h&&2==h.length&&(h=h[1].split("."),3==parseInt(h[0],10)&&6>=parseInt(h[1],10)&&(3==h.length?13>=parseInt(h[2],10)&&(f=!0):f=!0)))}f&&(a.g=e)}return a},p={};try{p.a=encodeURIComponent(top.location.href)}catch(q){}try{p.b=encodeURIComponent(parent.location.href)}catch(g){}if(s.embedded){try{p.c=encodeURIComponent(parent.document.referrer)}catch(A){}try{p.e=encodeURIComponent(x.document.referrer)}catch(v){}}try{"jsi"!==
l.mode&&(p.d=encodeURIComponent(x.location.href))}catch(k){}try{p.f=encodeURIComponent(l.jsref)}catch(r){}try{h=m(),p.g=encodeURIComponent(h.g||""),p.q=encodeURIComponent(h.q||""),a.isStarted()&&!h.g&&1<a.getMyFrameDepth()&&(p.g=encodeURIComponent(a.getTopDomain()))}catch(C){}p=e(p);p=f(p);h=[];for(var D in p)p.hasOwnProperty(D)&&h.push({key:D,val:p[D]});h.sort(function(a,b){return a.val.length>b.val.length?1:a.val.length<b.val.length?-1:0});return c=h};return{detectTopURL:h,getDetectedURLs:function(){return c?
...
function(){var a=r.getWindow().document,b=a.body?Math.round(t.getNodeArea(a.body)):null;!k.getAggregator().request("mobileApp").isMobileAppEnvironment()&&b&&Ba(a,"bs2",10,b)},{tier:g.TIERS.VIEWABILITY,applies:function(a,b,c){b=!a.bootstrapOn("app")&&!c.isDomless();return a.on("bbs")&&c.embedded&&b}});var tb=function(){return{createInstance:function(a){return s.isDomless()?new vc:new wc(a)}}},wc=function(a){var b,c,e,f=new ua,h=new fa,u=new xc(f),m=new yc,p=new zc,q=new Ac(f,a),g=function(){d.isUndef(e)&&
(e=new Bc(f));return e},A=function(){f.provide({frameCollection:function(){return u},adProxy:function(){return p},adTalkMessage:function(a){return new Cc(a,f)},adTalkMessageCollection:function(){return m},idMapModule:g,interFrameQuerySelector:function(a){return new Dc(a)}})};return{isApplicable:function(a){return d.isDef(x.JSON)&&d.isDef(x.postMessage)&&!a.isAvid()&&!a.isOmidNative()},start:function(){A();h.traverse(u.addFrame);q.startListening();q.sendToKnownFrames();k.getAggregator().once("stopAdTalk",
function(){q.stopListening()});k.getAggregator().provide("adTalkEventAggregator",f)},sendAdTalkCall:q.sendAdTalkCall,getFrameMap:function(){d.isUndef(b)&&(b=new Ca(f));return b},getFrameMapIncludingPeerCase:function(){d.isUndef(c)&&(c=new Ca(f,!0));return c},getIdMap:g}},vc=function(){return{isApplicable:function(){return!1},start:function(){}}},Cc=function(a,b){var c,e=b.request("adProxy").myIdCard,d=b.request("frameCollection").getMe().getStringifiedPosition();c=k.getAggregator().request("features").on("swapids")?
l.oid:l.asid;var h=a||{},u=l.asid,e=e.tagId,m=s.embedded,p=s.friendly,q=l.birthdate;c=c.split("-")[2];var w;s.friendly?w="["+g.AD_IDENTIFIER+"-"+l.asid+"]":(w=r.getWindow(),w=w.location&&w.location.href,w='iframe[src*="'+(w&&w.replace(/^https?\:\/\//i,""))+'"]');return{messageContent:h,srcAsid:u,srcTagId:e,srcIsEmbedded:m,srcIsFriendly:p,srcBirthdate:q,iasCommonId:c,nodeSelector:w,positionStr:d,version:"0.1"}},yc=function(){var a={};return{add:function(b){var c=b&&b.srcAsid;c&&(a[c]=b)},map:function(b){return d(a).map(b)},
has:function(b){return a[b&&b.srcAsid]}}},Ec=function(a,b,c,e){var f,h=a==x;f={position:b.slice(0),id:b.join("-"),isMe:h,isLeaf:!a.frames.length,adProxies:h?c:[],selfDescription:void 0,unifiedId:l.birthdate,srcIsEmbedded:e?e.srcIsEmbedded:void 0,inbox:e?[e]:[],getDomObj:function(){return a},getStringifiedPosition:function(){return d(f.position).map(function(a,b){return d.toBase(Number(b)+1,36)}).join("")},isValidForMapping:function(){return f.isLeaf||f.isMe||d.isDef(f.selfDescription)}};var u=function(a){var b=
...
h,u){var m=a.request("adProxy").getAll();d=new Ec(d,h,m,u);b.push(d);c[d.id]=d;d.isMe&&(e=d);return d},getFrame:function(a){return c[a]},list:b,dictionary:c,getMe:function(){return e}}},Ca=function(a,b){var c=function(a,c){var d=c.adProxies,m="";if(c.isValidForMapping()){if(b)m+=e(d,c.getStringifiedPosition());else{var p;p=""+c.getStringifiedPosition();p+=c.isMe?"*":"";p+=d.length?"."+d[0].tagId:"";m+=p}return m}},e=function(a,b){var c="";return c=a.length?c+d(a).stringify(function(a,c){return b+
(l.asid===c.adSafeId?"*":"")+"."+c.tagId},"|"):c+b};return{output:function(){var b=a.request("frameCollection"),e=d(b.list).stringify(c,"|");return d.toBase(b.getMe().unifiedId,62)+"+"+e}}},Bc=function(a){var b=a.request("frameCollection").getMe().getStringifiedPosition(),c=l.contextNode.parentNode,e=a.request("interFrameQuerySelector",c),d=function(a){return a&&a.substr(0,120)+".of"+a.length},h=function(a){var d=!1,d=!s.embedded,f="BODY"!==t.getNodeName(c)&&"HEAD"!==t.getNodeName(c),h;if(h=a.srcIsEmbedded){h=
...
k.getAggregator().trigger("stopAdTalk"));return c},isCandidateForMyIdMap:h}},Dc=function(a){var b=new fa,c=function(a){var b=a,c="IFRAME"===t.getNodeName(a),e=t.isWindow(a);c?b=a.contentWindow.document:e&&(b=a.document);return b},e=function(a,b){return t.querySelector(c(a),b)},f=function(c,f){var m,p,q;try{p=e(c,f),p||(m=b.getFrames(!0,a),d(m).findFirst(function(a,b){return q=e(b,f)}))}catch(g){}return p||q||null};return{queryFor:function(b){var c=null;b&&(c=f(a,b));return c}}},Ac=function(a){var b=
...
m,l,s,C;try{h=a.request("frameCollection");m=a.request("adTalkMessageCollection");l=e.messageContent.self;m.add(e);var D=h.getMe();D.unifiedId>l.unifiedId&&(D.unifiedId=l.unifiedId);var t;t=r.now()-e.sentTime;e.transferDuration=t;m=s=h.getFrame(l.id);d.isUndef(m)||d.isUndef(m.selfDescription)?(s=s||h.addFrame(c.source,l.id.split("-"),e),s.addInformationFromSrc(e,l),f()):s.addInformationFromSrc(e,l);(C=b&&a.request("idMapModule").isCandidateForMyIdMap(e))&&u()}catch(B){k.getAggregator().trigger("error",
g.ERROR_CODES.ADTALK_DUBIOUS)}};return{sendAdTalkCall:u,sendToKnownFrames:function(){(new ga).send(h)},startListening:function(){c=new va;c.listen(f,m,h)},stopListening:function(){c&&c.stop()},validateMessage:f,processMessage:m,createMessage:h}},Fc=function(){var a=k.getAggregator().request("ids"),b=a.getAsid();return{tagId:a.getFwId(),adSafeId:b}},zc=function(){var a,b=[],c=function(a){a=new Fc(a);b.push(a);return a};a=c();return{createNew:c,getAll:function(){return b},myIdCard:a}},Ab=function(a){var b,
c,e=!1,d=function(a){var d=!0;e&&(e=!1,a.stopPropagation?(a.stopPropagation(),a.preventDefault()):a.cancelBubble=!0,b=a.screenX-a.clientX,c=a.screenY-a.clientY,d=!1);return d};a.browserIs(g.BROWSERS.IE)&&y.addEvent(r.getDoc().documentElement,"click",d,!0);return{determineFramePosition:function(){a.browserIs(g.BROWSERS.IE)&&(e=!0,r.getDoc().documentElement.click());return{scrX:b,scrY:c}}}},Gc=function(a,b){var c,e=g.NA,f=e,h=!1,u=!1,m=!1,p=!b,q=function(){var b=r.getIntersectionObserver(function(a){a=
a.pop();var b=a.intersectionRect.width*a.intersectionRect.height/(a.boundingClientRect.width*a.boundingClientRect.height)*100;isNaN(b)&&(b=0);e=Math.min(b,100);c=a.boundingClientRect;e!==f&&r.execAtEndOfThread(function(){k.getAggregator().trigger("IOPivChange",e)});f=e},{threshold:g.VIEWABILITY_IN_VIEW_THRESHOLDS_INTERSECTION_OBSERVER});p&&r.execAtEndOfThread(function(){e===g.NA&&(e=0)});b.observe(w(a));p&&r.execAtEndOfThread(function(){s.isBustedIframe()||k.getAggregator().trigger("delayedViewabilityReady")});
h=!0},w=function(b){if(!d.isUndef(b)){if(m){b=a.document;var c=b.createElement("div");d(c.style).mixin({position:"absolute",width:"100%",opacity:"0",height:"100%",zIndex:-999,top:"0px",left:"0px"});c[g.IAS_DETECTOR]=!0;b.body.appendChild(c);b=c}return b}};return{getPiv:function(){return e},start:function(){var b;try{a.document&&(m=!0,b={bodyElement:a.document.body,document:a.document})}catch(c){u=!0}b&&null!==b.bodyElement?q():b&&b.document?y.whenReady(q,b.document):u?k.getAggregator().request("errors").add(g.ERROR_CODES.BUSTED_IFRAME_IN_IO):
q()},isStarted:function(){return h},getAdNodeDimensions:function(){var a;c&&(a=H({scrX:void 0,scrY:void 0,width:c.width,height:c.height}));return a},isReady:function(){return e!==g.NA}}},ra=function(){var a=!1;(function(){y.whenReady(function(){k.getAggregator().trigger("startViewabilityLoop");a=!0})})();return{loopStarted:function(){return a}}};k("loopDelay",[],ra,{applies:function(a,b,c){return a.bootstrapOn("allowViewability")},tier:g.TIERS.VIEWABILITY});var Hc=function(){return{start:function(a){k.getAggregator().on("measurable",
function(){a()})},isApplicable:function(a,b){return!b.browserIs(g.BROWSERS.WEBKIT)||!a.isImmediatelyMeasurable()}}},Ic=function(){return{start:function(a){a()},isApplicable:function(a){return a.isImmediatelyMeasurable()}}},Sb=function(a,b,c){var e=!1,f=function(){b.impressionIsIdentifiable()&&!e&&(e=!0,k.getAggregator().trigger("notify",l._onMeasurable))};return{start:function(){var b;b=[Jc(),Kc(),Ic(),Hc()];(b=d(b).findFirst(function(b,e){return e.isApplicable(c,a)}))&&b.start(f)},isApplicable:function(a){return a.bootstrapOn("useViewabilityNotification")&&
d.isDef(l._onMeasurable)}}},Kc=function(){return{start:function(a){bc(k.getAggregator(),["adImpression","measurable"]).onAll(function(){a()})},isApplicable:function(a,b){var c=9<=b.getIOSVersion();return(!b.browserIs(g.BROWSERS.WEBKIT)||c)&&s.isVideo()}}},Jc=function(){return{start:function(a){k.getAggregator().once("adImpression",function(){a()})},isApplicable:function(a){return a.isImmediatelyMeasurable()&&s.isVideo()}}},Lc=function(a,b,c){var e=["rjss","jss","jload"],f=function(){var b=!1,c=a.getAvidAdSessionContext();
...
c){return c.environment.accepts()})}}},Ta=function(a){var b=!1,c=!1,e=k.getAggregator().request("omidAdSessionContext"),f=k.getAggregator().request("omidAdSessionVerificationParameters"),h=r.getWindow(),g=(h=h&&h.omid3p)&&d.isFunction(h.registerSessionObserver)&&d.isFunction(h.addEventListener)?h:a,m=function(){return f&&f.IAS&&0<Object.keys(f.IAS).length?f.IAS:f},p=function(){var a,d;b&&c&&(x.omidSupported=!0,a=e.app&&e.isDisplay&&!e.isWeb,(d=l.mobFwUrl&&-1<l.mobFwUrl.indexOf("/blocking/"))&&e.isLimitedSandbox&&
"1"===l.adWidth&&"1"===l.adHeight&&(e.isLimitedSandbox=!1),a&&d&&(e.delayingViewabilityEvents=!0),k.getAggregator().trigger("tryToCallContinueMain",m()))},q=function(a){if("sessionStart"===a.type){e.adSessionType=a.data.context.adSessionType;e.environment=a.data.context.environment;e.omidNativeInfo=a.data.context.omidNativeInfo;e.omidJsInfo=a.data.context.omidJsInfo;e.deviceInfo=a.data.context.deviceInfo;e.app=a.data.context.app;e.isNative="native"===e.adSessionType;e.isLimitedSandbox=s.embedded;
e.isHtml="html"===a.data.context.adSessionType;e.isWeb="web"===a.data.context.environment;f=a.data.verificationParameters;a=e.isHtml&&e.isWeb;e.queuedOutputItems=[];for(var c=[{root:"omidNativeInfo",code:"onpn",field:"partnerName"},{root:"omidNativeInfo",code:"onpv",field:"partnerVersion"},{root:"omidJsInfo",code:"ojpn",field:"partnerName"},{root:"omidJsInfo",code:"ojpv",field:"partnerVersion"},{root:"omidJsInfo",code:"osev",field:"serviceVersion"},{root:"omidJsInfo",code:"oscv",field:"sessionClientVersion"},
{root:"app",code:"applv",field:"libraryVersion"},{root:"app",code:"appid",field:"appId"},{root:"deviceInfo",code:"dty",field:"deviceType"},{root:"deviceInfo",code:"osn",field:"os"},{root:"deviceInfo",code:"osv",field:"osVersion"}],d,h,q,g=0;g<c.length;g++)d=c[g].root,h=c[g].field,q=c[g].code,"object"===typeof e[d]&&"undefined"!==typeof e[d][h]&&e.queuedOutputItems.push({code:q,value:e[d][h]});e.queuedOutputItems.push({code:"oast",value:e.adSessionType});e.queuedOutputItems.push({code:"oenv",value:e.environment});
a?k.getAggregator().trigger("tryToCallContinueMain",m()):(b=!0,p())}},w=function(a){e.mediaType=a.data.mediaType;e.queuedOutputItems.push({code:"omtp",value:e.mediaType});a.data.viewport&&a.data.adView&&(e.impressionViewabilityMeasurement={data:{viewport:a.data.viewport,adView:a.data.adView}});e.isNativeVideo=e.isNative&&"video"===a.data.mediaType;e.isDisplay="display"===a.data.mediaType;c=!0;p()};return{start:function(){g.registerSessionObserver(q,"IAS");g.addEventListener("impression",w)}}},Ua=
...
c)},addVideoPlaybackEventListener:function(a){b.on("videoPlaybackEvent",a)}}},Rc=function(a,b){var c,e=function(a){var e,d,m;try{e=a.eventData.percentageInView,d=c&&75<=e,m={windowDimensions:{x:0,y:0,width:0,height:0},adDimensions:{x:0,y:0,width:0,height:0},containerDimensions:{x:0,y:0,width:0,height:0},shouldDelegateToDomBasedViewability:d,isMeasurable:0===e||75<=e,isObstructed:!1,isHidden:!1,numberOfAdverts:1,percentageInView:e,detectionMethod:"av"},b.trigger("screenLocationChanged",m)}catch(p){}};
return{start:function(){try{var b=a.getAvidAdSessionContext().avidAdSessionType;c="display"===b||"video"===b;a.addEventListener("viewability",e)}catch(d){}},addScreenLocationChangedListener:function(a){b.on("screenLocationChanged",a)}}},Sc=function(a,b){var c=[],e=(new Date).getTime(),f=0,h=0,u=!1,m=new Aa,p={isEmpty:function(){return 0===c.length},toString:function(){for(var a="{vEventCount:"+c.length+",vEvents:[",b=0;b<c.length;b++)var e=c[b],a=a+((0<b?",{":"{")+("t:"+e.t+",")+("tp:"+e.tp+",")+
("sl:"+e.sl+",")+("ad_duration:"+e.ad_duration+",")+("volume:"+e.volume)+"}");return a+"]}"}},q=function(){u=!0},w=function(a){try{var p="",m=a.hasOwnProperty("timestamp")?a.timestamp:(new Date).getTime(),q="n",w=!1;switch(a.type){case "start":p="adVideoStart";e=m;h=a.data.duration;1E3<h&&(h/=1E3);f=a.data.videoPlayerVolume;break;case "volumeChange":p="volumeChanged";f=a.data.videoPlayerVolume;break;case "firstQuartile":case "midpoint":case "thirdQuartile":case "complete":p="adVideo"+a.type.substring(0,
1).toUpperCase()+a.type.substring(1);w=!0;k.getAggregator().trigger("videoQuartileEvent",a);break;case "pause":case "bufferStart":p="pauseAd";break;case "resume":case "bufferFinish":p="resumeAd";break;case "skipped":p="adSkipped"}if(""!==p){var l=k.getAggregator().request("mScreenEvents");l&&(q=l.getCurrentLoc());c.push({t:m-e,tp:p,sl:q,ad_duration:h,volume:f})}if("loaded"===a.type&&d.isDef(a.data)){var r=["preroll","midroll","postroll","standalone"].indexOf(a.data.position),p=-1!==r?r+1:void 0,s=
!0===a.data.autoPlay?"autoplayed":"clicktoplay";!0===u?(d.isDef(p)&&k.getAggregator().trigger("addThrottledProp",g.DT_SLOT.ENVIRONMENT,"vbp",p),k.getAggregator().trigger("addThrottledProp",g.DT_SLOT.ENVIRONMENT,"vps",s)):(d.isDef(p)&&k.getAggregator().trigger("addOutputItem",{output:p},"vbp",{type:g.IMPRESSION_EVENT}),k.getAggregator().trigger("addOutputItem",{output:s},"vps",{type:g.IMPRESSION_EVENT}))}"start"===a.type&&k.getAggregator().trigger("omidAdDuration",{ad_duration:h});var t;"playerStateChange"===
a.type?t="fullscreen"===a.data.state?"AdEnteredFullscreen":"AdExitedFullscreen":-1!=="start|firstQuartile|midpoint|thirdQuartile|resume|bufferFinish".indexOf(a.type)?t="AdPlaying":-1!=="complete|pause|bufferStart|skipped".indexOf(a.type)&&(t="AdPaused");d.isDef(t)&&b.trigger("videoPlaybackEvent",{eventType:t,eventData:null});w&&k.getAggregator().trigger("sendDt",g.DT_CODES.VIDEO_EVENTS)}catch(K){__IntegralASDiagnosticCall("omidvideo",K,x.bootstrapper)}};return{start:function(){k.getAggregator().on("impressionsent",
q);k.getAggregator().provide({omidVideoEventsString:p});a.addEventListener("video",w);m.init()},addVideoPlaybackEventListener:function(a){b.on("videoPlaybackEvent",a)}}},Da=function(a,b){var c=!1,e=function(a){var e=a.percentageInView;c=!0;a.viewState=50<=e?g.IN_VIEW:g.OUT_OF_VIEW;a.outOfViewReason=50<=e?"":g.OUT_OF_VIEW_REASONS.GEOM;b.trigger("measurementChanged",a)};return{start:function(){k.getAggregator().trigger("addOutputItem",{output:g.MEDIA_TYPE.DISPLAY_CODE},g.MEDIA_TYPE_CODE,{type:g.IMPRESSION_EVENT});
a.addScreenLocationChangedListener(e);a.start()},getStrategyName:function(){return g.MEASUREMENT_STRATEGY.DISPLAY},addMeasurementChangedListener:function(a){b.on("measurementChanged",a)},isMeasurable:function(){return c}}},Tc=function(a,b,c){var e=d.isDef(a)?a.environment:void 0,f=d.isDef(a)?a.measurementStrategy:void 0,h=function(){return d.isDef(f)};d.isDef(b)&&b.start();return{hasMeasurementStrategy:h,getScreenLocationInfo:function(a){return b.create(a)},isImmediate:function(){return h()?e.isImmediate():
!0},isMeasurable:function(){return h()?f.isMeasurable():!1},isMediaType:function(a){return h()?e.isMediaType(a):!1},supportsAdContainerGeometry:function(){return a.environment.supportsAdContainerGeometry()},start:function(){h()&&e.start()},requiresDelayedViewabilityEvent:function(){h()&&b.requiresDelayedViewabilityEvent()}}},rb=function(a,b,c){var e=k.getAggregator().request("mobileApp");return{create:function(){var d=[],d=d.concat(a.getOmidMeasurementStrategies()),d=d.concat(a.getAvidMeasurementStrategies()),
d=d.concat(a.getMraidMeasurementStrategies());(d=(new ia(d)).resolve())||k.getAggregator().trigger("addOutputItem",{output:"0"},"oam",{type:"impression"});var h=new Uc(d),g=new Ea(b,c,s,e);return!d&&g.accepts()?new Vc(s.isVideo(),new E):new Tc(d,h,e.isMobileAppEnvironment())}}},sb=function(a){var b=k.getAggregator().request("mobileApp");return{getOmidMeasurementStrategies:function(){var a=k.getAggregator().request("omidVerificationClient"),b=new ba(a),d=new ya,h=[];if(b.accepts()&&!d.accepts()){var g=
new da,m=new Wc,d=new Xc(a,new E),g=[{environment:g,measurementStrategy:new Yc(a,new E)},{environment:m,measurementStrategy:new Fa(new ja,r.getWindow(),new E)}],g=(g=(new ia(g)).resolve())?g.measurementStrategy:{},p=new Ga(new Ha(new V),new V,m.accepts()),m=new Oc(a,b,l.mode),q=new Ia(d,g,new E,p),b=new Pc(a,b,l.mode),a=new Ja(d,g,new Sc(a,new E),new E,p);h.push({environment:m,measurementStrategy:q});h.push({environment:b,measurementStrategy:a})}return h},getAvidMeasurementStrategies:function(){var b=
k.getAggregator().request("avidJsClient"),e=new Mc(b),d=[];if(e.accepts()){var h=new Lc(b,e,l.mode),g=new Nc(b,e,l.mode),m;m=new Qc(b,new E);if(e.supportsAdContainerGeometry()){var p=new Zc,q=new $c,w=new Fa(new ja,r.getWindow(),new E),A=new ad(b,new E),p=(p=(new ia([{environment:p,measurementStrategy:A},{environment:q,measurementStrategy:w}])).resolve())?p.measurementStrategy:{},q=new Ga(new Ha(new V),new V,q.accepts()),w=new bd(b,new E),b=new Ia(w,p,new E,q);m=new Ja(w,p,m,new E,q)}else q=new Rc(b,
new E),b=new Da(q,new E),m=new Ka(q,m,new E);d.push({environment:h,measurementStrategy:b});d.push({environment:g,measurementStrategy:m});a.setAvidAdSessionContext(e.getAvidAdSessionContext())}return d},getMraidMeasurementStrategies:function(){var a=[],e=b.isSafeToInjectMraid(),e=new cd(r.getWindow(),e,b.isMobileAppEnvironment());if(e.accepts()){var d=k.getAggregator().request("context"),d=new dd(r.getWindow(),d),h=new ed(r.getWindow(),new E);d.accepts()?(e=new fd(r.getWindow(),new E),e=new Ka(h,e,
new E),e={environment:d,measurementStrategy:e}):(d=new Da(h,new E),e={environment:e,measurementStrategy:d});a.push(e)}return a}}},ia=function(a){return{resolve:function(){var b=d(a).findFirst(function(a,b){return b.environment.accepts()});if(d.isDef(b))return b}}},Uc=function(a){var b=!1,c,e={winDimensions:H({scrX:0,scrY:0,width:0,height:0}),adDimensions:H({scrX:0,scrY:0,width:0,height:0}),containerDimensions:H({scrX:0,scrY:0,width:0,height:0}),method:g.NA,viewState:g.NA,percentInView:g.PIV_NA,reason:"",
obstructed:g.NA,isHidden:g.NA,tabHidden:g.NA,posViewState:g.NA,adCompCount:1},f=function(a){return a?new H({scrX:a.x,scrY:a.y,width:a.width,height:a.height}):H({scrX:0,scrY:0,width:0,height:0})},h=function(a){c={winDimensions:f(a.windowDimensions),adDimensions:f(a.adDimensions),containerDimensions:f(a.containerDimensions),method:a.detectionMethod||g.NA,viewState:a.viewState||g.NA,percentInView:d.isDef(a.percentageInView)?a.percentageInView:g.PIV_NA,reason:a.outOfViewReason||"",obstructed:d.stringifyTriState(a.isObstructed),
isHidden:g.NA,tabHidden:g.NA,posViewState:a.viewState||g.NA,adCompCount:1,shouldDelegateToDomBasedViewability:a.shouldDelegateToDomBasedViewability,sliceStatus:a.sliceStatus,isVideoPlaying:a.isVideoPlaying,isVideoPlayingInFullscreen:a.isVideoPlayingInFullscreen,isSoundOn:a.isSoundOn};a.isMeasurable&&b&&(b=!1,k.getAggregator().trigger("delayedViewabilityReady"))};return{create:function(b){var f=e;if(d.isDef(c))if(a.environment.supportsAdContainerGeometry())f=c;else if(c.shouldDelegateToDomBasedViewability)f=
b,f.method=c.method;else if(0===c.percentInView||75<=c.percentInView)f=c;return f},start:function(){var b;d.isDef(a)&&d.isDef(a.measurementStrategy)&&(b=a.measurementStrategy,b.addMeasurementChangedListener(h),b.start())},requiresDelayedViewabilityEvent:function(){b=!0}}},Ka=function(a,b,c){var e=!1,f=!1,h=!1,u,m,p,q,w=function(){if(!d.isUndef(m)){var a=[],b,w;e?(f?(w=!1,b=100):(w=q,b=p),50>b&&a.push(g.OUT_OF_VIEW_REASONS.GEOM)):(w=!1,b=0,a.push(g.OUT_OF_VIEW_REASONS.VIDEO));h=!0;m.shouldDelegateToDomBasedViewability=
w;m.percentageInView=b;m.viewState=50>b?g.OUT_OF_VIEW:g.IN_VIEW;m.outOfViewReason=a.join(".");u=m;c.trigger("measurementChanged",u)}},l=function(a){m=a;p=a.percentageInView;q=a.shouldDelegateToDomBasedViewability;w()},v=function(a){a=a.eventType;"AdEnteredFullscreen"===a?f=!0:"AdExitedFullscreen"===a?f=!1:-1!=="AdStarted|AdVideoStart|AdPlaying".indexOf(a)?e=!0:-1!=="AdSkipped|AdUserClose|AdPaused|AdVideoComplete|AdStopped".indexOf(a)&&(e=!1);w()};return{start:function(){k.getAggregator().trigger("addOutputItem",
{output:g.MEDIA_TYPE.VIDEO_CODE},g.MEDIA_TYPE_CODE,{type:g.IMPRESSION_EVENT});a.addScreenLocationChangedListener(l);a.start();b.addVideoPlaybackEventListener(v);b.start()},getStrategyName:function(){return g.MEASUREMENT_STRATEGY.VIDEO},addMeasurementChangedListener:function(a){c.on("measurementChanged",a)},isMeasurable:function(){return h}}},dd=function(a,b){return{accepts:function(){return b.isInMobiMraidVideo()},isImmediate:function(){return!1},supportsAdContainerGeometry:function(){return!1},start:function(){try{var b;
a.inmobi.IASDocumentVideoBuffer.addVideoEventListener(function(a){"AdVideoStart"!==a.type||b||(b=!0,k.getAggregator().trigger("adImpression"))})}catch(e){}}}},fd=function(a,b){var c=function(a){try{b.trigger("inMobiMraidVideoPlaybackEvent",{eventType:a.type})}catch(c){}};return{start:function(){try{a.inmobi.IASDocumentVideoBuffer.addVideoEventListener(c)}catch(b){}},addVideoPlaybackEventListener:function(a){b.on("inMobiMraidVideoPlaybackEvent",a)}}},bd=function(a,b){var c=function(a){a={viewport:a.eventData.viewport||
{width:0,height:0},originalAdContainer:a.eventData.originalAdContainer||{x:0,y:0,width:0,height:0},computedAdContainer:a.eventData.computedAdContainer||{x:0,y:0,width:0,height:0},percentageInView:a.eventData.percentageInView,detectionMethod:g.DETECTION_METHODS.AVID,outOfViewReason:e(a.eventData.reasons)};b.trigger(g.CONTAINER_GEOMETRY_MEASUREMENT_CHANGED,a)},e=function(a){var b={inactive:g.OUT_OF_VIEW_REASONS.FOCUS,viewport:g.OUT_OF_VIEW_REASONS.GEOM,clipped:g.OUT_OF_VIEW_REASONS.GEOM,obstructed:g.OUT_OF_VIEW_REASONS.OBSTRUCTION,
backgrounded:g.OUT_OF_VIEW_REASONS.FOCUS,notFound:g.OUT_OF_VIEW_REASONS.HIDDEN},c=[];if(!a)return"";d(a).each(function(a,e){var d=b[e];d&&0>c.indexOf(c)&&c.push(d)});return c.join(".")};return{start:function(){a.addEventListener("viewability",c)},addAdContainerGeometryMeasurementChangedListener:function(a){b.on(g.CONTAINER_GEOMETRY_MEASUREMENT_CHANGED,a)},translateAvidOutOfViewReasons:e}},Ga=function(a,b,c){function e(a,b,c){c=m(b,c);a=h(a,b,c);return a.width*a.height}var f=function(a,b){var c=Math.max(a.x,
b.x),e=Math.max(a.y,b.y),d=Math.min(a.x+a.width,b.x+b.width),f=Math.min(a.y+a.height,b.y+b.height),d=d-c,f=f-e;return{x:c,y:e,width:0<d?d:0,height:0<f?f:0}},h=function(a,b,c){a=f(b,a);return f(c,{x:0,y:0,width:a.width,height:a.height})},u=function(a,b){return{x:a.x+b.x,y:a.y+b.y,width:b.width,height:b.height}},m=function(a,b){return{x:b.x-a.x,y:b.y-a.y,width:b.width,height:b.height}};return{calculateGeometricMeasurement:function(f,q){if(d.isDef(f)&&d.isDef(q)){var w=f.viewport,k=f.computedAdContainer,
l=k.obstructions,s=l&&0<l.length,t=f.originalAdContainer,C=q.adGeometry,D=q.adFound,N=f.detectionMethod,B=0,w={x:0,y:0,width:w.width,height:w.height},F=u(t,C),K=f.outOfViewReason,P=0,I=0,x=s||!1,P=1>=C.width*C.height;c&&P&&(D=!1,K=K||"",D||-1!==K.indexOf(g.OUT_OF_VIEW_REASONS.GEOM)||(K=g.OUT_OF_VIEW_REASONS.GEOM+(""!==K?"."+K:"")));if(D&&0<f.percentageInView){P=e(w,k,F);s?(B=m(k,F),B=h(w,k,B),B=u(k,B),B=a.calculateObstructedArea(B,l)):B=0;I=B;B=Math.round((P-I)/(F.width*F.height)*100);s&&0===I&&(x=
!1);for(var C=x,y,s=0,D=b.getConfig(F).numberOfSlices,I=r.floor(F.height/D)||1,l=[],P=C?a.getObstructionStatusBySlice(D):[],W,s=0;s<D;s++)y=F.y+I*s,s==D-1&&(I=F.y+F.height-y),y={x:F.x,y:y,width:F.width,height:I},W=e(w,k,y),y=1==W/(y.width*y.height),l.push(y);if(C)for(k=r.min(P.length,D),s=0;s<k;s++)l[s]=l[s]&&!P[s];k=l}else k=b.getConfig(C).defaultSliceArray;return{windowDimensions:w,containerDimensions:t,adDimensions:F,percentageInView:B,viewState:50<=B?g.IN_VIEW:g.OUT_OF_VIEW,outOfViewReason:50<=
...
!s.isAvidNative()}}},Ia=function(a,b,c,e){var f,h,u,m=function(){if(d.isDef(f)&&d.isDef(h)){var a=e.calculateGeometricMeasurement(f,h);u=a.isMeasurable=!0;c.trigger("geometryMeasurementChanged",a)}},p=function(a){f=a;m()},q=function(a){h=a;m()};return{start:function(){k.getAggregator().trigger("addOutputItem",{output:g.MEDIA_TYPE.DISPLAY_CODE},g.MEDIA_TYPE_CODE,{type:g.IMPRESSION_EVENT});a.addAdContainerGeometryMeasurementChangedListener(p);a.start();b.addAdGeometryMeasurementChangedListener(q);b.start()},
addMeasurementChangedListener:function(a){c.on("geometryMeasurementChanged",a)},getStrategyName:function(){return g.MEASUREMENT_STRATEGY.DISPLAY},isMeasurable:function(){return u}}},Ha=function(a){var b=[],c;return{calculateObstructedArea:function(e,f){var h,g,m,p;g=f&&0<f.length;var q;if(g){q=Math.round(e.width);var k=Math.round(e.height);h=Array(q);for(m=0;m<q;m++)h[m]=Array(k);q={matrix:h,obscuredPixelCount:0,x:Math.round(e.x),y:Math.round(e.y),width:q,height:k}}else q={};h=q;k=q=0;if(g){for(;q<
f.length;q++){g=f[q];m=k=h;var l=g;h=Math.max(m.x,l.x);g=Math.max(m.y,l.y);p=Math.min(m.x+m.width,l.x+l.width);l=Math.min(m.y+m.height,l.y+l.height);m=p-h;p=l-g;m=0<m?m:0;p=0<p?p:0;h-=k.x;g-=k.y;m=h+m;p=g+p;for(h=Math.round(h);h<Math.round(m);h++)for(l=Math.round(g);l<Math.round(p);l++)void 0!==k.matrix[h]&&void 0===k.matrix[h][l]&&(k.matrix[h][l]=1,k.obscuredPixelCount+=1);h=k}k=h.obscuredPixelCount;q=h;if(d.isUndef(q.matrix)||0===q.matrix.length)c=[];else{g=0;p=!1;h=q.matrix[0].length;m=q.matrix.length;
p=a.getConfig({height:h}).numberOfSlices;for(var l=r.floor(h/p)||1,v=[],s=0;s<h;s++){p=!1;for(var t=0;t<m;t++)if(1===q.matrix[t][s]){p=!0;break}g++;p&&(s+=l-g,g=l);if(g==l||s===h-1)v.push(p),g=0}c=v}}else c=b;return k},getObstructionStatusBySlice:function(){return c}}},Xc=function(a,b){var c=k.getAggregator().request("omidAdSessionContext"),e=null,f=!1,h=function(){var a=r.getDoc().getElementById("iasbi"+l.asid);a&&a.hasAttribute("CreativeLoaded")?(f=c.delayingViewabilityEvents=!1,e&&(u(e),e=null)):
r.setTimeout(h,50)},u=function(a){var d=a.data.adView,k=!!(d.measuringElement&&d.containerGeometry&&d.onScreenContainerGeometry);c.delayingViewabilityEvents?(e=a,f||(f=!0,h())):(k&&d.onScreenGeometry.obstructions&&0<d.onScreenGeometry.obstructions.length&&(d.onScreenContainerGeometry.obstructions=d.onScreenGeometry.obstructions),a={viewport:a.data.viewport||{width:0,height:0},originalAdContainer:d[k?"containerGeometry":"geometry"]||{x:0,y:0,width:0,height:0},computedAdContainer:d["onScreen"+(k?"Container":
"")+"Geometry"]||{x:0,y:0,width:0,height:0},percentageInView:d.percentageInView,detectionMethod:g.DETECTION_METHODS.OMID,outOfViewReason:m(d.reasons)},b.trigger(g.CONTAINER_GEOMETRY_MEASUREMENT_CHANGED,a))},m=function(a){var b={inactive:g.OUT_OF_VIEW_REASONS.FOCUS,viewport:g.OUT_OF_VIEW_REASONS.GEOM,clipped:g.OUT_OF_VIEW_REASONS.GEOM,obstructed:g.OUT_OF_VIEW_REASONS.OBSTRUCTION,backgrounded:g.OUT_OF_VIEW_REASONS.FOCUS,notFound:g.OUT_OF_VIEW_REASONS.HIDDEN},c=[];if(!a)return"";d(a).each(function(a,
e){var d=b[e];d&&0>c.indexOf(c)&&c.push(d)});return c.join(".")};return{start:function(){void 0!==c.impressionViewabilityMeasurement&&u(c.impressionViewabilityMeasurement);a.addEventListener("geometryChange",u)},addAdContainerGeometryMeasurementChangedListener:function(a){b.on(g.CONTAINER_GEOMETRY_MEASUREMENT_CHANGED,a)},translateOmidOutOfViewReasons:m}},da=function(){var a=k.getAggregator().request("omidAdSessionContext");return{accepts:function(){return a&&(a.isNative||a.isLimitedSandbox)}}},Yc=
function(a,b){var c=k.getAggregator().request("omidAdSessionContext"),e=null,d=!1,h=function(){var a=r.getDoc().getElementById("iasbi"+l.asid);a&&a.hasAttribute("CreativeLoaded")?(d=c.delayingViewabilityEvents=!1,e&&(u(e),e=null)):r.setTimeout(h,50)},u=function(a){if(a&&a.data&&a.data.adView)if(c.delayingViewabilityEvents)e=a,d||(d=!0,h());else{var p=a.data.adView.geometry,q=a.data.adView.containerGeometry,k=!!p;a=a.data.adView.measuringElement&&!!q;b.trigger(g.MOBILE_APP_GEOMETRY_MEASUREMENT_CHANGED,
{adGeometry:{x:k&&a?p.x-q.x:0,y:k&&a?p.y-q.y:0,width:k?p.width:0,height:k?p.height:0},adFound:k})}};return{start:function(){void 0!==c.impressionViewabilityMeasurement&&u(c.impressionViewabilityMeasurement);a.addEventListener("geometryChange",u)},addAdGeometryMeasurementChangedListener:function(a){b.on(g.MOBILE_APP_GEOMETRY_MEASUREMENT_CHANGED,a)}}},Wc=function(){var a=k.getAggregator().request("omidAdSessionContext");return{accepts:function(){return a&&!a.isNative}}},Ja=function(a,b,c,e,f){var h=
!1,u=!1,m,p,q,l,r,v=function(){if(!(d.isUndef(p)||d.isUndef(q)||d.isUndef(l))){r=!0;var a=f.calculateGeometricMeasurement(p,q),b=h&&u,c=h&&50<=a.percentageInView,k={windowDimensions:a.windowDimensions,containerDimensions:a.containerDimensions,adDimensions:a.adDimensions,percentageInView:a.percentageInView,detectionMethod:a.detectionMethod,isMeasurable:!0,isObstructed:a.isObstructed,sliceStatus:a.sliceStatus,isVideoPlaying:h,isVideoPlayingInFullscreen:b,isSoundOn:!0};b&&(k.percentageInView=100);b||
c?k.viewState=g.IN_VIEW:(k.viewState=g.OUT_OF_VIEW,k.outOfViewReason=a.outOfViewReason||g.OUT_OF_VIEW_REASONS.VIDEO);m=k;e.trigger("videoGeometryMeasurementChanged",m)}},s=function(a){p=a;v()},t=function(a){q=a;v()},C=function(a){l=a;a=a.eventType;"AdEnteredFullscreen"===a?u=!0:"AdExitedFullscreen"===a?u=!1:-1!=="AdStarted|AdVideoStart|AdPlaying".indexOf(a)?h=!0:-1!=="AdSkipped|AdUserClose|AdPaused|AdVideoComplete|AdStopped|AdError".indexOf(a)&&(h=!1);v()};return{start:function(){k.getAggregator().trigger("addOutputItem",
{output:g.MEDIA_TYPE.VIDEO_CODE},g.MEDIA_TYPE_CODE,{type:g.IMPRESSION_EVENT});a.addAdContainerGeometryMeasurementChangedListener(s);a.start();b.addAdGeometryMeasurementChangedListener(t);b.start();c.addVideoPlaybackEventListener(C);c.start()},getStrategyName:function(){return g.MEASUREMENT_STRATEGY.VIDEO},addMeasurementChangedListener:function(a){e.on("videoGeometryMeasurementChanged",a)},isMeasurable:function(){return r}}},Fa=function(a,b,c){var e,f=function(){var b=a.find(),f,m=!0;d.isDef(b)?(f=
b.getBoundingClientRect(),f={x:f.left,y:f.top,width:f.width,height:f.height},b.hasOwnProperty("adWasClipped")&&(f.adWasClipped=!0)):m=!1;if(b=m)b=f,b=!d.isDef(e)||!1!==d(b).compareTo(e);b&&(e=f,c.trigger(g.MOBILE_APP_GEOMETRY_MEASUREMENT_CHANGED,{adGeometry:f,adFound:m}))};return{start:function(){f();b.setInterval(f,50)},addAdGeometryMeasurementChangedListener:function(a){c.on(g.MOBILE_APP_GEOMETRY_MEASUREMENT_CHANGED,a)}}},cd=function(a,b,c){return{accepts:function(){var e=d(a.mraid).isObj();return c&&
(e||b)},isImmediate:function(){return!0},supportsAdContainerGeometry:function(){return!1},start:function(){}}},ed=function(a,b){var c=!1,e=function(){var c,e,d;try{c=a.mraid.isViewable()?100:0;var f={x:0,y:0,width:0,height:0};d=100===c?[!0]:[!1];e={windowDimensions:f,adDimensions:f,containerDimensions:f,shouldDelegateToDomBasedViewability:!1,isMeasurable:!0,isObstructed:!1,isHidden:!1,percentageInView:c,detectionMethod:g.DETECTION_METHODS.MRAID,sliceStatus:d};b.trigger("mraidScreenLocationChanged",
e)}catch(h){}},f=function(){var b=a.mraid;return d(b).isObj()&&d.isFunction(b.isViewable)},h=function(){var b=a.mraid;e();b.addEventListener("viewableChange",e)},u=function(){var b=a.mraid;f()&&(c=!0,"loading"===b.getState()?b.addEventListener("ready",function(){h()}):h())},m=function(){c||u()};return{start:function(){var b=!0;if(d.isDef(a.mraid)||t.containsScriptTagWithSrc("mraid.js"))b=!1;k.getAggregator().trigger("addOutputItem",{output:d.stringifyTriState(b)},"mi",{type:"impression"});b?k.getAggregator().trigger("exec",
"mraid.js",m):u()},addScreenLocationChangedListener:function(a){b.on("mraidScreenLocationChanged",a)}}},db=function(a,b,c){var e={},f=function(c){var e=d.noop;b.bootstrapOn("useViewabilityNotification")&&(e=function(){a.skipAsFraudulent()||k.getAggregator().trigger("notify",c)});return e};(function(){c&&d(c).map(function(a,b){e[a]=f(b)})})();return{getCallbacks:function(){return e}}},Ya=function(){var a=new Q({tiv:[1E4]}),b=d([g.IN_VIEW,g.PARTIAL_VIEW_PLUS]);return{timeInViewThresholds:a,type:g.DT_CODES.FULLY_INVIEW,
rts:{},isInView:function(a){var e=r.max(a.fullPercentInView||0,a.percentInView);return b.contains(a.viewState)&&100===e},applies:function(a,b){return a.on("abcAudit")&&925955==l.anId&&b.usesIASFullyInViewCustomMetric()},minUnit:1E3,shouldIncludeSound:!1}},Xa=function(a,b){var c,e,d;c=a.on("everySecond");var h=b.isVideo();e=[1E3,2E3,3E3,4E3,5E3,6E3,7E3,8E3,9E3,1E4,11E3,12E3,13E3,14E3,15E3];d=[1E3,5E3,15E3,3E4,45E3,6E4,9E4];var k=[2E3,5E3,15E3];c?(c=new Q({tiv:e}),e=e[0]):h?(c=new Q({tiv:k}),e=k[0]):
(c=new Q({tiv:d}),e=d[0]);d={5E3:l._onInViewMRC5,15E3:l._onInViewMRC15};d[e]=l._onInViewMRC;return{timeInViewThresholds:c,type:g.DT_CODES.PING,rts:d,isInView:function(a){return-1!==(g.IN_VIEW+"|"+g.PARTIAL_VIEW_PLUS).indexOf(a.viewState)},applies:!0,minUnit:1E3,shouldIncludeSound:!1}},$a=function(a,b){var c;c=a.on("everySecond");var e=b.isVideo(),d=b.usesIASFullyInViewCustomMetric(),h=[1E3,2E3,3E3,4E3,5E3,6E3,7E3,8E3,9E3,1E4,11E3,12E3,13E3,14E3,15E3],u=[1E3,5E3,15E3],m=[2E3,5E3,15E3],p=function(a){var b=
r.max(a.fullPercentInView||0,a.percentInView);return-1!==(g.IN_VIEW+"|"+g.PARTIAL_VIEW_PLUS).indexOf(a.viewState)&&100===b};c=c?new Q({tiv:h}):e?new Q({tiv:m}):new Q({tiv:u});k.getAggregator().provide("isFullyInViewProvider",{isFullyInView:p});return{timeInViewThresholds:c,type:g.DT_CODES.FULLY_INVIEW,isInView:p,applies:function(){return d},minUnit:1E3,shouldIncludeSound:!1}},Za=function(a,b){return{timeInViewThresholds:new Q({tiv:[0]}),type:g.DT_CODES.FULLY_INVIEW,rts:{0:l._onInViewFull},isInView:function(a){var b=
r.max(a.fullPercentInView||0,a.percentInView);return-1!==(g.IN_VIEW+"|"+g.PARTIAL_VIEW_PLUS).indexOf(a.viewState)&&100===b},applies:function(){return b.usesGroupMCustomMetric()},minUnit:1E3,shouldIncludeSound:!1}},bb=function(a,b){var c,e,f,h=r.getMaxNumber(),k=b.isVideo(),m=a.id;e=a.sound&&"on"===a.sound;var p=!(a.soundExcl&&"groupm_native"===a.soundExcl&&l.groupm_native_publisher)&&e;c=new Q(a);e=a.qiv;(function(){f={};var a;d.isDef(l.rts)&&d.isDef(l.rts[m])&&(a=c&&d.isFunction(c.getTimeThresholds)&&
c.getTimeThresholds()[0],a=d.isDef(a)?d.isFunction(a.getTimeInViewForRts)&&a.getTimeInViewForRts():g.RTS_KEY_FOR_VQ,f[a]=l.rts[m])})();return{timeInViewThresholds:c,qivThreshold:e,type:g.DT_CODES.CUSTOM,rts:f,isInView:function(b){if(!b.adDimensions)return!1;var c,e,f,m=b.adDimensions.area(),l=1===b.tabHidden,s=r.max(b.fullPercentInView||0,b.percentInView);c=d(a.thresholds).findFirst(function(a,b){e=b.lb||0;f=b.ub||h;if(m>=e&&m<=f)return!0});c=!l&&s>=c.piv;b.method==g.DETECTION_METHODS.AD_PLACEHOLDER&&
0===a.tiv&&(c=!1);k&&(c=c&&b.isVideoPlaying,p&&(c=c&&b.isSoundOn));return c},metricId:m,minUnit:a.minunit?1E3*a.minunit:1E3,thresholdType:a.thresholdType,shouldIncludeSound:p}},ab=function(a,b,c){var e=b.isVideo()?"video":"display",f=b.isMobileApp()?"app":"web",h=b.isDeviceTypeGroupMobile()?"mobile":"desktop",g=d(a.customViewability).isArray()&&0<a.customViewability.length,m=c.on("customMetric"),p=c.on("groupmCM"),q=function(a,b){var c,g,m,q,k;c=d(b.mediaTypes).contains(e);g=d(b.distributionChannels).contains(f);
m=d.isDef(b.deviceGroups)?d(b.deviceGroups).contains(h):!0;q=O.contains(b.id,"fiv");k=O.contains(b.id,"groupmCM");q=!q;k&&(q=p);return q&&c&&g&&m};return{resolve:function(){var b=[],c;m&&g&&(c=d(a.customViewability).filter(q),d(c).each(function(a,c){b.push(c)}));return b}}},Q=function(a){var b=[];if(d(a.tiv).isArray())d(a.tiv).each(function(a,c){b.push(new ka(c))});else if("string"===typeof a.tiv){a=a.tiv.split("|");var c=new gd;b.push(new hd(c,parseInt(a[1].replace("%"))));b.push(new ka(1E3*parseInt(a[0])))}else d.isDef(a.tiv)&&
b.push(new ka(1E3*a.tiv));return{getTimeThresholds:function(){return b}}},gd=function(){var a=-1,b=function(b){0<a||(b=d.isDef(b.ad_duration)?b.ad_duration:b.adRemainingTime,void 0!==b&&0<b&&(a=Math.ceil(b)))};k.getAggregator().on({omidAdDuration:b,adVideoStart:b,adDurationChange:b});return{getAdDuration:function(){return a},isVideoDurationResolved:function(){return 0<a}}},ka=function(a){var b=0,c;0<a&&(b=a/1E3);c=1E3*b;return{getTimeInViewInSeconds:function(){return b},getTimeInViewForRts:function(){return c}}},
hd=function(a,b){var c=0,e=!1,d=function(a){c=0;0<b&&0<a&&(c=r.ceil(b/100*a))};d(15);return{getTimeInViewInSeconds:function(){!e&&a.isVideoDurationResolved()&&(e=!0,d(a.getAdDuration()));return c},getTimeInViewForRts:function(){return 0}}},gb=function(a,b,c){var e=function(e){a.isInView(e)?(b.mark(),c.doEligibleJobs(b.getTotalTime())):b.stop()};return{start:function(){a.addMeasurementChangedListener(e)}}},fb=function(a,b,c,e){var f,h,g,m,p,q,l=function(a,b){return!b&&a},r=function(a,b,c,e){return e?
!0:!b&&(a||e)&&c},v=function(a){var k=0,l=1===a.tabHidden,w=a.isVideoPlaying,v=a.isSoundOn,t=a.isVideoPlayingInFullscreen;d(a.sliceStatus).each(function(a,b){g(b,l,w,t)?f[a].mark():f[a].stop();m[a]=f[a].getTotalTime()});s("slcVt",m);e&&(d(a.sliceStatus).each(function(a,b){r(b,l,w,t)&&v?h[a].mark():h[a].stop();p[a]=h[a].getTotalTime()}),s("slcVtVol",p));q=e&&b&&b.shouldIncludeSound?p:m;a=d(q).findFirst(function(a,b){k=Math.max(k,b);return 0>=b});d.isUndef(a)&&c.doEligibleJobs(k)},s=function(a,b){var c=
{};c[a]=b;k.getAggregator().trigger("addOutputItem",{output:c},{minDt:!1})},t=function(a){!f&&a.sliceStatus&&(f=[],h=[],m=[],p=[],d(a.sliceStatus).each(function(a){f.push(new ca(1));m.push(0);e&&(h.push(new ca(1)),p.push(0))}))},C=function(a){d.isUndef(a.sliceStatus)||(f||t(a),v(a))};return{start:function(){g=e?r:l;a.addMeasurementChangedListener(C)}}},cb=function(a,b){return{isInView:a.isInView,addMeasurementChangedListener:function(a){b.addMeasurementChangedListener(a)}}},Kb=function(a,b,c,e,d,
h,k,m,p,q){var l=!1,A=s.isVideo(),v=h.request("mobileApp"),t=Z().applies(c,d),x=c.browserIs(g.BROWSERS.GECKO)||c.browserIs(g.BROWSERS.IE)&&d.on("rattie")||t,C=s.xDomainIframe&&!x,D=new wa(10),y=function(){d.on("viewabilityready")&&!l&&(e.send(g.DT_CODES.VIEWABILITY_READY),h.trigger("measurable"),l=!0)};h.on("delayedViewabilityReady",function(){B();y()});h.on("delayedViewabilityReadyCallOnly",y);var B=function(c){c=c||!1;try{D.start();var e,d;b.hasMeasurementStrategy()?d=v.isMobileAppEnvironment()&&
...
l.oid):m.push("uid:"+e.unq);m.push("v:19.8.67");m.push("sp:"+(l.isSplitMode?1:0));m.push("fwm:"+("true"===l.fwMonitoring?1:0));c.on("resolution")&&(m.push("wr:"+d(t.windowSize()).toArray().join(".")),m.push("sr:"+d(t.screenSize()).toArray().join(".")));b=function(){var a;a=String(l.scriptUrl).toLowerCase();var b=a.indexOf("ias_xpc");-1<b?(a=a.substring(b+7+1),b=a.indexOf("&"),a=-1<b?a.substring(0,b):a):a="NotFound";return a||""}();"NotFound"!==b&&m.push("x_xpc:"+b);return m},ae=function(a,b,c,e){var f,
